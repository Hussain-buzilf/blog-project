...
import{ AiQutlineMenu,AiQutlineClose }
...
const Header = () => {
  const [navIsVisible, setIsVisible] = useState(false);
  ...
  return (
    <section>
      <header className="container mx-auto px-5 flex justify-between py-4 items-center">
        ...
        <div>
          {navIsVisible  ? <AiQutlineClose  onClick={navVisibilityHandler}/>
          : <AiQutlineMenu onClick={navVisibilityHandler}/>}
